    ...
    <div v-else class="relative font-poppins bg-white">
      ...
      >
        <div
          ...
          :key="recipe.id"
          class="flex flex-col bg-white w-96 border-2 border-green-100 rounded-xl overflow-hidden flex-shrink-0 snap-center transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
        >
          ...
          <div class="p-6 flex flex-col flex-1">
            <NuxtLink :to="`/recipes/${recipe.id}`" class="group">
              <h2 class="text-xl font-bold text-green-800 mb-2 group-hover:text-green-600 transition-colors">
