...
import { UIMultipleImages } from "#components";
    ...
    <div class="w-full pt-2 px-8 py-8 md:px-8">
      ...
      >
        ...
        <div class="w-full flex flex-col sm:mb-3 justify-center gap-2">
          <label
            for=""
            class="pl-3 ml-px text-sm font-medium text-gray-700 dark:text-gray-50"
            >Profile
          </label>
          <UIImage
            name="profile"
        ...
        <div class="flex justify-center mt-4">
          <button
            class="bg-green-400 border-2 rounded-full px-6 mb-2 py-2 hover:bg-green-400 hover:ring-blue-500 hover:border-blue-500"
          >
