      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
          ...
          <p class="max-w-2xl mx-auto text-lg text-gray-600">
            Discover recipes loved by our community, sorted by bookmarks
          </p>
        </div>
        ...
        <div v-else-if="recipes.length === 0" class="text-center py-16 bg-white rounded-xl shadow-sm border border-gray-100">
          <div class="max-w-md mx-auto">
            <Icon name="material-symbols:bookmark-outline" class="mx-auto h-16 w-16 text-gray-400" />
            <h3 class="mt-4 text-lg font-medium text-gray-900">No popular recipes yet</h3>
            <p class="mt-2 text-sm text-gray-600">
              Recipes will appear here as they get bookmarked by users
            </p>
            <NuxtLink 
              to="/recipes" 
              class="mt-6 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
...
// GraphQL query for popular recipes (sorted by bookmarks)
